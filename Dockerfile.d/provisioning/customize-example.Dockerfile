...
LABEL org.opencontainers.image.source="https://github.com/mazgi/container-image.provisioning/blob/main/Dockerfile.d/provisioning/customize-example.Dockerfile"
